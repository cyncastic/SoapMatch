  ...
  def create
    ...
    respond_to do |format|
      if @note_category.save
        format.html { redirect_to note_category_url(@note_category), notice: "Note category was successfully created." }
  ...
  def update
    respond_to do |format|
      if @note_category.update(note_category_params)
        format.html { redirect_to note_category_url(@note_category), notice: "Note category was successfully updated." }
